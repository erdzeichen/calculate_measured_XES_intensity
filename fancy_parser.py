'''Fancy chemical parser from Tim Peters on http://code.activestate.com/lists/python-tutor/84/'''
import re
# symbol, name, atomic number, molecular weight
def wrapper(stringen):
	...
	def parse_sequence():
		...
		return seq
	return parse(stringen).displaysyms()